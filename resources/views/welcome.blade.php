...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased dark:bg-black dark:text-white/50" style="background-image: url('../../login-form/images/bg.jpg'); background-repeat: no-repeat;">
...
<body>
    <header class="hero">
        <div>
            ...
            <a href="#features" class="btn-custom">Learn More</a>
        </div>
    </header>
    <section id="features" class="features container text-center">
        ...
        <div class="row mt-4">
            <div class="col-md-4 feature-box">
                ...
                <p>We bring creative solutions to complex problems.</p>
            </div>
            <div class="col-md-4 feature-box">
                <i class="fas fa-cogs fa-3x text-primary"></i>
                <h3>Easy Customization</h3>
                <p>Our platform is user-friendly and highly customizable.</p>
            </div>
            <div class="col-md-4 feature-box">
